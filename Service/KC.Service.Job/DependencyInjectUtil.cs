    ...
    public static class DependencyInjectUtil
    {
        public static void InjectService(IServiceCollection services)
        {
            services
                ...
                .AddDbContext<ComJobContext>(options =>
                {
                    //解决跟踪同一个ID问题
            ...
            services.AddTransient(typeof(EFUnitOfWorkContextBase), typeof(ComJobUnitOfWorkContext));
            ...
            services.AddScoped<IThreadConfigRepository, ThreadConfigRepository>();
            services.AddScoped<IThreadStatusRepository, ThreadStatusRepository>();
            services.AddScoped<IDatabaseVersionInfoRepository, DatabaseVersionInfoRepository>();

            services.AddScoped<IJobDbService, JobDbService>();
            services.AddScoped<IThreadService, ThreadDbService>();
