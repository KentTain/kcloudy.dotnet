...
namespace KC.Service.DTO.Portal
{
    ...
    public class WebSiteTemplateColumnDTO : EntityDTO
    {
        public WebSiteTemplateColumnDTO()
        {
            WebSiteItems = new List<WebSiteTemplateItemDTO>();
        }
        ...
        [DataMember]
        public ICollection<WebSiteTemplateItemDTO> WebSiteItems { get; set; }
    }
}
