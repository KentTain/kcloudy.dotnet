    ...
    public static class DependencyInjectUtil
    {
        public static void InjectService(IServiceCollection services)
        {
            services
                ...
                .AddDbContext<ComWorkflowContext>(options =>
                    {
                        //解决跟踪同一个ID问题
            ...
            services.AddTransient(typeof(EFUnitOfWorkContextBase), typeof(ComWorkflowUnitOfWorkContext));
            ...
            services.AddScoped<IWorkflowDefNodeRepository, WorkflowDefNodeRepository>();
            services.AddScoped<IWorkflowVerDefinitionRepository, WorkflowVerDefinitionRepository>();
            
            services.AddScoped<IWorkflowProcessRepository, WorkflowProcessRepository>();
            services.AddScoped<IWorkflowProTaskRepository, WorkflowProTaskRepository>();
            services.AddScoped<IWorkflowProTaskExecuteRepository, WorkflowProTaskExecuteRepository>();
            
            services.AddTransient<IModelDefinitionService, ModelDefinitionService>();
