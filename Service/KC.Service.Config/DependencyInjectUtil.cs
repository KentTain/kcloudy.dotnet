    ...
    public static class DependencyInjectUtil
    {
        public static void InjectService(IServiceCollection services)
        {
            services
                ...
                .AddDbContext<ComConfigContext>(options =>
                {
                    //解决跟踪同一个ID问题
            ...
            services.AddScoped(typeof(EFUnitOfWorkContextBase), typeof(ComConfigUnitOfWorkContext));
            ...
            services.AddScoped<IConfigEntityRepository, ConfigEntityRepository>();
            services.AddScoped<ISysSequenceRepository, SysSequenceRepository>();
