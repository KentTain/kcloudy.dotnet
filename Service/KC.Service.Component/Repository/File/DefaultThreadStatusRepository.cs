...
{
    public class DefaultThreadStatusRepository : CommonFileRepository<ThreadStatusInfoTable>, IThreadStatusRepository
    {
        public DefaultThreadStatusRepository()
            : base("ThreadStatusInfo")
        {
        }

        public DefaultThreadStatusRepository(Tenant tenant)
            : base(tenant)
        {
        }
        ...
        {
            return this.FindAll().Select(m => m as ThreadStatusInfo).ToList();
        }
