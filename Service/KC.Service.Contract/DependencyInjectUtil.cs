    ...
    public static class DependencyInjectUtil
    {
        public static void InjectService(IServiceCollection services)
        {
            services
                ...
                .AddDbContext<ComContractContext>(options =>
                {
                    //解决跟踪同一个ID问题
            ...
            services.AddTransient(typeof(EFUnitOfWorkContextBase), typeof(ComContractUnitOfWorkContext));
            ...
            services.AddTransient<ITenantSimpleApiService, TenantSimpleApiService>();
            services.AddTransient<IElectronicSignApiService, ElectronicSignApiService>();
            services.AddTransient<IContractApiService, ContractApiService>();

            services.AddTransient<IContractGroupRepository, ContractGroupRepository>();
            services.AddTransient<IUserContractRepository, UserContractRepository>();

            services.AddTransient<IContractService, ContractService>();
            services.AddTransient<IElectronicSignService, ElectronicSignService>();
