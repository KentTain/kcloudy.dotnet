    ...
    public static class DependencyInjectUtil
    {
        public static void InjectService(IServiceCollection services)
        {
            services
                ...
                .AddDbContext<ComCodeContext>(options =>
                {
                    //解决跟踪同一个ID问题
            ...
            services.AddTransient(typeof(EFUnitOfWorkContextBase), typeof(ComCodeUnitOfWorkContext));
            ...
            services.AddTransient<IModelDefinitionRepository, ModelDefinitionRepository>();
            services.AddTransient<IRelationDefinitionRepository, RelationDefinitionRepository>();
            services.AddTransient<IModelDefFieldRepository, ModelDefFieldRepository>(); 

            services.AddTransient<IModelDefinitionService, ModelDefinitionService>();
            services.AddTransient<IRelationDefinitionService, RelationDefinitionService>();
