    ...
    public static class DependencyInjectUtil
    {
        public static void InjectService(IServiceCollection services)
        {
            services
                ...
                .AddDbContext<ComAppContext>(options =>
                {
                    //解决跟踪同一个ID问题
            ...
            services.AddTransient(typeof(EFUnitOfWorkContextBase), typeof(ComAppUnitOfWorkContext));
            ...
            services.AddTransient<IAppDevelopService, AppDevelopService>();
