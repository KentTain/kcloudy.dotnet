...
{
    public class TenantUserAuthenticationDTO : EntityDTO
    {
        [DataMember]
        ...
        /// </summary>
        [DataMember]
        public BlobInfoDTO EnterpriseQualificationPhotoBlob
        {
            get
            {
                if (EnterpriseQualificationPhoto.IsNullOrEmpty())
                    return null;

                return SerializeHelper.FromJson<BlobInfoDTO>(EnterpriseQualificationPhoto);
            }
        }
