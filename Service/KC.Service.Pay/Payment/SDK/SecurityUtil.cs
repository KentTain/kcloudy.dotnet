...
namespace KC.Service.Pay.SDK
{
    public static class SecurityUtil
    {
        ...
        public static string AlgorithmSha1 = "SHA1";
        ...
        public static byte[] Deflater(byte[] inputByte)
        {
            ...
            var memory = new MemoryStream();
            var def = new ICSharpCode.SharpZipLib.Zip.Compression.Deflater();
        ...
        public static string EncryptData(string dataString, string encoding)
        {
            ...
            try
            {
                data = EncryptedData(Encoding.UTF8.GetBytes(dataString));
                return EncodeBase64(Encoding.Default, System.Text.Encoding.Default.GetString(data));
            }
            catch (Exception e)
            {
