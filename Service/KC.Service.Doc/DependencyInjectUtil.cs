    ...
    public static class DependencyInjectUtil
    {
        public static void InjectService(IServiceCollection services)
        {
            services
                ...
                .AddDbContext<ComDocContext>(options =>
                {
                    //解决跟踪同一个ID问题
            ...
            services.AddTransient(typeof(EFUnitOfWorkContextBase), typeof(ComDocUnitOfWorkContext));
            ...
            services.AddTransient<IDocTemplateRepository, DocTemplateRepository>();
            services.AddTransient<IDocumentInfoRepository, DocumentInfoRepository>();
