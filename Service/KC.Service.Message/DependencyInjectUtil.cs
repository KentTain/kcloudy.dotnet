    ...
    public static class DependencyInjectUtil
    {
        public static void InjectService(IServiceCollection services)
        {
            services
                ...
                .AddDbContext<ComMessageContext>(options =>
                {
                    //解决跟踪同一个ID问题
            ...
            services.AddTransient(typeof(EFUnitOfWorkContextBase), typeof(ComMessageUnitOfWorkContext));
            ...
            services.AddScoped<IMessageCategoryRepository, MessageCategoryRepository>();
            services.AddScoped<IMessageClassRepository, MessageClassRepository>();
            services.AddScoped<IMessageTemplateRepository, MessageTemplateRepository>();

            services.AddScoped<IMemberRemindMessageRepository, MemberRemindMessageRepository>();

            services.AddScoped<INewsBulletinCategoryRepository, NewsBulletinCategoryRepository>();

            services.AddTransient<IMessageService, MessageService>();
            services.AddTransient<INewsBulletinService, NewsBulletinService>();
