...
{
    public class ComDictUnitOfWorkContext : EFUnitOfWorkContextBase
    {
        public ComDictUnitOfWorkContext(ComDictContext context)
        {
        ...
        protected ComDictContext ComDbContext { get; private set; }
    }
}
