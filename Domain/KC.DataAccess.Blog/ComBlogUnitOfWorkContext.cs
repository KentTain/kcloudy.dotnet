...
{
    public class ComBlogUnitOfWorkContext : EFUnitOfWorkContextBase
    {
        public ComBlogUnitOfWorkContext(ComBlogContext context)
        {
        ...
        protected ComBlogContext ComConfigContext { get; private set; }
    }
}
