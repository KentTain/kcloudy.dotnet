...
{
    public class ComTrainingDatabaseInitializer : MultiTenantSqlServerDatabaseInitializer<ComTrainingContext>
    {
        public ComTrainingDatabaseInitializer()
        { }

        public override ComTrainingContext Create(Tenant tenant)
        {
            if (tenant == null)
            ...
            return new ComTrainingContext(options, tenant, null, null);
        }
