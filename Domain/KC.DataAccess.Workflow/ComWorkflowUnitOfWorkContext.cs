...
{
    public class ComWorkflowUnitOfWorkContext : EFUnitOfWorkContextBase
    {
        public ComWorkflowUnitOfWorkContext(ComWorkflowContext context)
        {
        ...
        protected ComWorkflowContext ComDbContext { get; private set; }
    }
}
