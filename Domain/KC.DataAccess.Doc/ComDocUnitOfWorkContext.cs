...
{
    public class ComDocUnitOfWorkContext : EFUnitOfWorkContextBase
    {
        public ComDocUnitOfWorkContext(ComDocContext context)
        {
        ...
        protected ComDocContext ComDbContext { get; private set; }
    }
}
