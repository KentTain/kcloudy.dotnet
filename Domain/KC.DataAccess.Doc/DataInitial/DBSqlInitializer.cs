...
namespace KC.DataAccess.Doc.DataInitial
{
    public static class DBSqlInitializer
    {
        public static List<string> lines = EmbeddedFileHelper.GetEmbeddedFileContents("KC.DataAccess.Doc.DataInitial.CurrentVersion.txt");
        ...
        {
            return EmbeddedFileHelper.GetEmbeddedFileContents("KC.DataAccess.Doc.DataInitial.SchemaUpgrade.SQL_" + version + ".sql");
        }
        public static List<string> GetStructureSqlScript()
        {
            return EmbeddedFileHelper.GetEmbeddedFileContents("KC.DataAccess.Doc.DataInitial.SQL_Structure.sql");
        }
        public static List<string> GetInitialDataSqlScript()
        {
            return EmbeddedFileHelper.GetEmbeddedFileContents("KC.DataAccess.Doc.DataInitial.SQL_InitialData.sql");
        }
    }
}
