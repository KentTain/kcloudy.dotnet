...
{
    public class ComConfigDatabaseInitializer : MultiTenantSqlServerDatabaseInitializer<ComConfigContext>
    {
        public ComConfigDatabaseInitializer()
        { }

        public override ComConfigContext Create(Tenant tenant)
        {
            if (tenant == null)
            ...
            return new ComConfigContext(options, tenant, null, null);
        }
