...
{
    public class ComSupplierUnitOfWorkContext : EFUnitOfWorkContextBase
    {
        public ComSupplierUnitOfWorkContext(ComSupplierContext context)
        {
        ...
        protected ComSupplierContext ComDbContext { get; private set; }
    }
}
