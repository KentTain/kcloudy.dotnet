...
{
    public class ComOfferingUnitOfWorkContext : EFUnitOfWorkContextBase
    {
        public ComOfferingUnitOfWorkContext(ComOfferingContext context)
        {
        ...
        protected ComOfferingContext ComDbContext { get; private set; }
    }
}
