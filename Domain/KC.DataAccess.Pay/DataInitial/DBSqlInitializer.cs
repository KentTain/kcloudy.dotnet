...
namespace KC.DataAccess.Pay.DataInitial
{
    public static class DBSqlInitializer
    {
        public static List<string> lines = EmbeddedFileHelper.GetEmbeddedFileContents("KC.DataAccess.Pay.DataInitial.CurrentVersion.txt");
        ...
        {
            return EmbeddedFileHelper.GetEmbeddedFileContents("KC.DataAccess.Pay.DataInitial.SchemaUpgrade.SQL_" + version + ".sql");
        }
        public static List<string> GetStructureSqlScript()
        {
            return EmbeddedFileHelper.GetEmbeddedFileContents("KC.DataAccess.Pay.DataInitial.SQL_Structure.sql");
        }
        public static List<string> GetInitialDataSqlScript()
        {
            return EmbeddedFileHelper.GetEmbeddedFileContents("KC.DataAccess.Pay.DataInitial.SQL_InitialData.sql");
        }
    }
}
