...
namespace KC.DataAccess.Job
{
    ...
    /// 数据库初始化操作类
    /// </summary>
    public class ComJobDatabaseInitializer : MultiTenantSqlServerDatabaseInitializer<ComJobContext>
    {
        public ComJobDatabaseInitializer()
            : base()
        { }

        public override ComJobContext Create(Tenant tenant)
        {
            if (tenant == null)
            ...
            return new ComJobContext(options, tenant);
        }
