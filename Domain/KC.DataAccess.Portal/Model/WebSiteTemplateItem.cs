...
namespace KC.Model.Portal
{
    ...
    /// 页面项目
    /// </summary>
    [Table(Tables.WebSiteTemplateItem)]
    [Serializable, DataContract(IsReference = true)]
    public class WebSiteTemplateItem : Entity
    {
        [Key]
        ...
        [ForeignKey("WebSiteTemplateColumnId")]
        public virtual WebSiteTemplateColumn WebSiteColumn { get; set; }
    }
}
