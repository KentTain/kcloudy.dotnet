...
{
    [Table(Tables.RecommendRequirement)]
    public class RecommendRequirement : Entity
    {
        public RecommendRequirement()
        {
        ...
        [NotMapped]
        public IEnumerable<RecommendMaterial> RecommendMaterials => RequirementForMaterials.Select(e => e.RecommendMaterial);
    }
}
