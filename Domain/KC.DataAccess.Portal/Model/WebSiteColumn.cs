...
namespace KC.Model.Portal
{
    ...
    /// 页面项目组
    /// </summary>
    [Table(Tables.WebSiteColumn)]
    [Serializable, DataContract(IsReference = true)]
    public class WebSiteColumn : Entity
    {
        public WebSiteColumn()
        {
            WebSiteItems = new List<WebSiteItem>();
        }
        ...
        [ForeignKey("WebSitePageId")]
        public virtual WebSitePage WebSitePage { get; set; }
