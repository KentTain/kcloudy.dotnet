...
namespace KC.DataAccess.App.DataInitial
{
    public static class DBSqlInitializer
    {
        ...
        {
            return EmbeddedFileHelper.GetEmbeddedFileContents("KC.DataAccess.App.DataInitial.SchemaUpgrade.SQL_" + version + ".sql");
        }
        public static List<string> GetStructureSqlScript()
        {
            return EmbeddedFileHelper.GetEmbeddedFileContents("KC.DataAccess.App.DataInitial.SQL_Structure.sql");
        }
        public static List<string> GetInitialDataSqlScript()
        {
            return EmbeddedFileHelper.GetEmbeddedFileContents("KC.DataAccess.App.DataInitial.SQL_InitialData.sql");
        }
    }
}
