...
{
    public class ComCodeUnitOfWorkContext : EFUnitOfWorkContextBase
    {
        public ComCodeUnitOfWorkContext(ComCodeContext context)
        {
        ...
        protected ComCodeContext ComDbContext { get; private set; }
    }
}
