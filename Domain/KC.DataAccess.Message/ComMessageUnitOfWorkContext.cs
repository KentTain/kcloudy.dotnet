...
{
    public class ComMessageUnitOfWorkContext : EFUnitOfWorkContextBase
    {
        public ComMessageUnitOfWorkContext(ComMessageContext context)
        {
        ...
        protected ComMessageContext ComDbContext { get; private set; }
    }
}
