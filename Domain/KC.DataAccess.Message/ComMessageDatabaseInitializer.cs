...
namespace KC.DataAccess.Message
{
    ...
    /// 数据库初始化操作类
    /// </summary>
    public class ComMessageDatabaseInitializer : MultiTenantSqlServerDatabaseInitializer<ComMessageContext>
    {
        public ComMessageDatabaseInitializer()
            : base()
        { }

        public override ComMessageContext Create(Tenant tenant)
        {
            if (tenant == null)
            ...
            return new ComMessageContext(options, tenant);
        }
