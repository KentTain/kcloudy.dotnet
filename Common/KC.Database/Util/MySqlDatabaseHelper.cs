...
namespace KC.Database.Util
{
    public class MySqlDatabaseHelper
    {
        ...
        public static int ExecuteNonQuery(string connectString, string sql, IEnumerable<MySqlParameter> parameters, bool avoidEventTrigger = false, int retryNumber = 0, bool logStatement = false, string logTitle = null)
        {
        ...
        public static int TranExecuteNonQuery(string connectString, string sql, IEnumerable<MySqlParameter> parameters, bool avoidEventTrigger = false, int retryNumber = 0, bool logStatement = false, string logTitle = null)
        {
            if (retryNumber == 0 || string.IsNullOrEmpty(logTitle))
                logTitle = "ExecuteNonQuery - " + new StackFrame(1).GetMethod().Name;
            ...
            try
            {
                ...
                using (var connection = new MySqlConnection(connectString))
                {
                    ...
                    using (var sqlTransaction = connection.BeginTransaction())
                    {
                        try
                        {
                            using (var command = PrepareCommand(connection, sql, parameters, sqlTransaction))
                            {
                                try
                                {
                                    affectRows = command.ExecuteNonQuery();
        ...
        public static object ExecuteScalar(string connectString, string sql, IEnumerable<MySqlParameter> parameters, int retryNumber = 0, bool logStatement = false, string logTitle = null)
        {
            if (retryNumber == 0 || string.IsNullOrEmpty(logTitle))
        ...
        public static MySqlDataReader ExecuteReader(string connectString, string sql, IEnumerable<MySqlParameter> parameters, int retryNumber = 0, bool logStatement = false, string logTitle = null)
        {
            if (retryNumber == 0 || string.IsNullOrEmpty(logTitle))
        ...
        public static DataSet ExecuteDataSet(string connectString, string tableName, string sql, IEnumerable<MySqlParameter> parameters, bool fillSchema = false, int executeTimeout = -1, int retryNumber = 0, bool logStatement = false, string logTitle = null)
        {
            if (retryNumber == 0 || string.IsNullOrEmpty(logTitle))
                    ...
                    try
                    {
                        using (var command = PrepareCommand(connection, sql, parameters))
                        {
                            try
                            {
                                ...
                                dataSet = new DataSet();
                                using (var sqlAdapter = new MySqlDataAdapter(command))
                                {
                                    if (fillSchema)
                                    {
        ...
        public static string GetSqlStatementFromSqlCommand(string sql, IEnumerable<MySqlParameter> parameters)
        {
        ...
        private static MySqlCommand PrepareCommand(MySqlConnection connection, string sql, IEnumerable<MySqlParameter> parameters, MySqlTransaction transaction = null)
        {
            ...
            MySqlCommand command = transaction == null ? new MySqlCommand(sql, connection) : new MySqlCommand(sql, connection, transaction);
        ...
        private static string GetParameterValueForSQL(MySqlParameter parameter)
        {
            ...
            switch (parameter.MySqlDbType)
            {
                ...
                //case MySqlDbType.NVarChar:
                case MySqlDbType.Text:
                case MySqlDbType.Time:
                //case MySqlDbType.Xml:
        ...
        private static void AssignParameterValues(MySqlParameter[] parameters, object[] parameterValues)
        {
        ...
        private static bool IsTransient(Exception ex)
        {
            if (ex != null)
            {
                ...
                if ((sqlException = ex as MySqlException) != null)
                {
                    ...
                    foreach (MySqlError err in sqlException.Data)
                    {
                        errorMessage += "SQL Error: " + err.Code + ", Message: " + err.Message + Environment.NewLine;
                        switch (err.Code)
                        {
