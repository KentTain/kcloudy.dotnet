...
using KC.GitLabApiClient.Internal.Http.Serialization;
using KC.GitLabApiClient.Models.Oauth.Requests;
using KC.GitLabApiClient.Models.Oauth.Responses;
using KC.GitLabApiClient.Models.Uploads.Requests;
using KC.GitLabApiClient.Models.Uploads.Responses;

namespace KC.GitLabApiClient.Internal.Http
{
    internal sealed class GitLabHttpFacade
    {
        ...
        public Task<T> Post<T>(string uri, IEnumerable<KeyValuePair<string, string>> keyValues) =>
            _requestor.Post<T>(uri, keyValues);

        public Task Post(string uri, IEnumerable<KeyValuePair<string, string>> keyValues) =>
            _requestor.Post(uri, keyValues);
