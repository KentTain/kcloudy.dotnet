...
namespace KC.Framework.Exceptions
{
    ...
    [Serializable]
    public class BusinessApiException : System.Exception
    {
        /// <summary>
        ...
        public BusinessApiException(string message, System.Exception inner)
            : base(message, inner) { }
        ...
        protected BusinessApiException(SerializationInfo info, StreamingContext context)
            : base(info, context) { }
    }
}
