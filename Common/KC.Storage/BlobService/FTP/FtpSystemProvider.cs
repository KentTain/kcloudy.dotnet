...
{
    public class FtpSystemProvider : ProviderBase, IBlobProvider
    {
        private readonly string RootPath;
        private readonly string StorageConnectionString;
        private readonly FtpSystemReader Reader;
        private readonly FtpSystemWriter Writer;

        //public FtpSystemProvider()
        //{
        ...
        public FtpSystemProvider(Tenant tenant)
        {
            this.StorageConnectionString = tenant.GetDecryptStorageConnectionString();
            this.Reader = new FtpSystemReader(this.StorageConnectionString);
            this.Writer = new FtpSystemWriter(this.StorageConnectionString);
        }

        public FtpSystemProvider(string connectionString)
        {
            this.StorageConnectionString = connectionString;
            if (string.IsNullOrWhiteSpace(StorageConnectionString))
                throw new ArgumentException("Local Storage's connect string is empy or null.", "connectionString");
            ...
            this.Reader = new FtpSystemReader(connectionString);
            this.Writer = new FtpSystemWriter(connectionString);
        }
