...
using KC.IdentityServer4.Configuration.DependencyInjection;
using KC.IdentityServer4.Endpoints;
...
using KC.IdentityServer4.Stores.Serialization;
...
using KC.IdentityServer4.Infrastructure;
using Microsoft.AspNetCore.Authentication.Cookies;
using Microsoft.AspNetCore.Authentication;
using static KC.IdentityServer4.Constants;
using KC.IdentityServer4.Extensions;
using KC.IdentityServer4.Hosting.FederatedSignOut;
using KC.IdentityServer4.Services.Default;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class IdentityServerBuilderExtensionsCore
    {
            ...
            where T : class, IEndpointHandler
        {
            ...
            builder.Services.AddSingleton(new KC.IdentityServer4.Hosting.Endpoint(name, path, typeof(T)));
