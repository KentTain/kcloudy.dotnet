...
using static KC.IdentityModel.OidcConstants;
using KC.IdentityServer4.Services;
using KC.IdentityServer4.Events;

namespace KC.IdentityServer4.AspNetIdentity
{
    /// <summary>
    /// IResourceOwnerPasswordValidator that integrates with ASP.NET Identity.
    /// </summary>
    /// <typeparam name="TUser">The type of the user.</typeparam>
    /// <seealso cref="KC.IdentityServer4.Validation.IResourceOwnerPasswordValidator" />
