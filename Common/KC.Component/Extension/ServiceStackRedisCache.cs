...
namespace Microsoft.Extensions.Caching.ServiceStackRedis
{
    ...
    {
        private readonly RedisHelper _redisManager;
        ...
        public ServiceStackRedisCache(IOptions<ServiceStackRedisCacheOptions> optionsAccessor)
        {
            ...
            var redisConn = RedisHelper.GetRedisConnectionString(_options.Configuration);
            var readWriteHosts = new List<string>() { redisConn };
            _redisManager = new RedisHelper(13, readWriteHosts);
        }
