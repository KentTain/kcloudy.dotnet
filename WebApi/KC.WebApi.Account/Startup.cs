...
namespace KC.WebApi.Account
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            StaticFactoryUtil.ConfigureApiClientService(services, Configuration, ApplicationConstant.AccScope, profiles);
...
GlobalConfig.DatabaseConnectionString, GlobalConfig.StorageConnectionString, GlobalConfig.QueueConnectionString, GlobalConfig.ServiceBusConnectionString, GlobalConfig.NoSqlConnectionString);
            ...
            //services.AddHttpClient<IAccountService, AccountService>().SetHandlerLifetime(TimeSpan.FromMinutes(TimeOutConstants.CacheShortTimeOut));
            //services.AddHttpClient<ISysManageService, SysManageService>().SetHandlerLifetime(TimeSpan.FromMinutes(TimeOutConstants.CacheShortTimeOut));
        }
