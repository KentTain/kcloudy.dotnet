...
{
    public abstract class AdminTestBase : CommonTestBase
    {
        protected IServiceProvider ServiceProvider;

        protected ITenantUserService TenantUserService;
        protected ITenantUserApiService TenantUserApiService;

        private static ILogger _logger;
        public AdminTestBase(CommonFixture data)
            : base(data)
        {
            _logger = LoggerFactory.CreateLogger(nameof(AdminTestBase));
        ...
        protected override void SetUp()
        {
            ...
            ServiceProvider = Services.BuildServiceProvider();
            TenantUserService = ServiceProvider.GetService<ITenantUserService>();
