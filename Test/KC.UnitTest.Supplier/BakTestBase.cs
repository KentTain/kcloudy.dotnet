...
{
    public abstract class BakTestBase : CommonTestBase
    {
        protected IServiceProvider ServiceProvider;
        private static ILogger _logger;
        public BakTestBase(CommonFixture data)
            : base(data)
        {
            _logger = LoggerFactory.CreateLogger(nameof(BakTestBase));
        ...
        protected override void InjectTenant(Framework.Tenant.Tenant tenant)
        {
            ...
            KC.Service.Supplier.DependencyInjectUtil.InjectService(Services);
