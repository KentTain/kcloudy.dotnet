...
{
    public abstract class OfferingTestBase : CommonTestBase
    {
        protected IServiceProvider ServiceProvider;
        private ILogger _logger;

        public OfferingTestBase(CommonFixture data)
            : base(data)
        {
            _logger = LoggerFactory.CreateLogger(nameof(OfferingTestBase));
