    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var profiles = KC.Service.AutoMapper.AutoMapperConfiguration.GetAllProfiles()
                .Union(KC.Service.Pay.AutoMapper.AutoMapperConfiguration.GetAllProfiles());
            StaticFactoryUtil.ConfigureIdentityServer4ClientServiceWithProviderExtension(
                services, Configuration,
                new string[] { ApplicationConstant.OpenIdScope, ApplicationConstant.ProfileScope, ApplicationConstant.DocScope }, profiles, true);

            KC.Service.Pay.DependencyInjectUtil.InjectService(services);
