layui.define(['layer', 'carousel'], function (exports) {
    ...
    var renderDom = function (elem, stepItems, postion) {
        ...
        for (var i = 0; i < stepItems.length; i++) {
            // 宽度
            var width = stepItems[i].width;
            if (width) {
                stepDiv += '<div class="step-item" style="width:' + width + '">';
            } else {
                stepDiv += '<div class="step-item" style="width:' + bfb + '%">';
            }
    ...
    layui.link('/lib/layui/plugins/step/step.css');
    exports('step', step);
});
