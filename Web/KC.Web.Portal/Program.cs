        ...
        public static void Main(string[] args)
        {
            try
            {
                ...
                using (var scope = host.Services.CreateScope())
                {
                    ...
                    #region 初始化数据库及数据：KC.DataAccess.Account
                    ...
                    var dataInitializer = new DataAccess.Portal.ComPortalDatabaseInitializer();
                    ...
                    dataInitializer.SeedData(TenantConstant.TestTenantApiAccessInfo);
                    dataInitializer.SeedData(TenantConstant.BuyTenantApiAccessInfo);
                    dataInitializer.SeedData(TenantConstant.SaleTenantApiAccessInfo);
                    Console.WriteLine("--end to Initialize the tenant--dba.");
                    #endregion
                }
