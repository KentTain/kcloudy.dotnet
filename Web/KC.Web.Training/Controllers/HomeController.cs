...
namespace KC.Web.Training.Controllers
{
    public class HomeController : Web.Controllers.TenantWebBaseController
    {
        ...
        [Web.Extension.MenuFilter("配置管理", "配置管理", "/Home/ConfigManager",
            Version = TenantConstant.DefaultVersion, TenantType = TenantConstant.DefaultTenantType, SmallIcon = "fa fa-television", AuthorityId = "A015AC93-7222-4918-8CD8-E73E6720E087",
