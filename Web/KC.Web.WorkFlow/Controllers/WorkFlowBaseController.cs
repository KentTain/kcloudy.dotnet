...
{
    public abstract class WorkflowBaseController : Web.Controllers.TenantWebBaseController
    {
        ...
        [Microsoft.AspNetCore.Mvc.HttpGet]
        public async Task<JsonResult> GetRootOrganizationsWithUsers()
        {
            var res = await AccountApiService.LoadOrgTreesWithUsers();
            return Json(res);
        }
