...
FLOW.registerBaseEvent = function() {
	...
	//		debugger;
	//		let draggableId = ui.draggable.context.firstElementChild.id;
	//		let offset = ui.offset;
	//		console.log('---id: ' + draggableId + "; offset: " + offset);
	//		FLOW.createNewNode(draggableId, offset);
	//	}
	//});
