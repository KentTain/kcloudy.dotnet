...
var nodeMenuJson = [
	...
	},
	{
		...
		id: "connRouteFront",
		callback: function(tempId) {
			myWORKFLOW.showConnectionRoute(tempId, 'front');
		}
	},
	{
		name: "显示节点后续路径",
		id: "connRouteBehind",
		callback: function(tempId) {
			myWORKFLOW.showConnectionRoute(tempId, 'behind');
		}
	}
];
...
var connectionMenuJson = [
	...
	},*/
	{
		...
		id: "deleteConnection",
		callback: function(tempId) {
			myWORKFLOW.deleteConnection(tempId);
		}
	}
];
