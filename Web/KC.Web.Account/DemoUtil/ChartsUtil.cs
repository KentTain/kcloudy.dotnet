...
namespace KC.Web.Account.DemoUtil
{
    public class ChartsUtil
    {
        ...
        public static string ConvertChartsData(ChartData chartData)
        {
            ...
            if (chartData.data != null)
            {
                ...
                {
                    str += "var " + data.Key + " =" + EChartJsonUtil.ObjectToJson2(data.Value) + ";\r\n ";
                }
            }
            ...
            if (chartData.fun != null)
            {
                ...
                {
                    str += "var " + fun.Key + " =" + EChartJsonUtil.ObjectToJson2(fun.Value) + ";\r\n ";
                }
            }
            ...
            if (chartData.fundata != null)
            {
                ...
                {
                    str += "var " + fd.Key + " =" + EChartJsonUtil.ObjectToJson2(fd.Value) + ";\r\n ";
                }
            }
            ...
            if (chartData.beforeRaw != null)
            {
                ...
                {
                    str += EChartJsonUtil.ObjectToJson2(raw) + ";\r\n ";
                }
            }
            if (chartData.option != null)
            {
                ...
                {
                    str += "myChart.setOption( option = " + EChartJsonUtil.ObjectToJson2(chartData.option) + ");\r\n";
                }
                else
                {
                    str += "option =" + EChartJsonUtil.ObjectToJson2(chartData.option) + ";\r\n ";
                }
            }
