        ...
        public static void Main(string[] args)
        {
            try
            {
                ...
                using (var scope = host.Services.CreateScope())
                {
                    ...
                    #region 初始化数据库及数据：KC.DataAccess.Offering
                    ...
                    var dataInitializer = new DataAccess.Offering.ComOfferingDatabaseInitializer();
