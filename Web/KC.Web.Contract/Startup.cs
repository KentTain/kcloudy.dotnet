    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var profiles = KC.Service.AutoMapper.AutoMapperConfiguration.GetAllProfiles()
                .Union(KC.Service.Contract.AutoMapper.AutoMapperConfiguration.GetAllProfiles());
            StaticFactoryUtil.ConfigureIdentityServer4ClientServiceWithProviderExtension(
                services, Configuration,
                new string[] { ApplicationConstant.OpenIdScope, ApplicationConstant.ProfileScope, ApplicationConstant.EconScope }, profiles, true);

            KC.Service.Contract.DependencyInjectUtil.InjectService(services);
