        ...
        public static void Main(string[] args)
        {
            try
            {
                ...
                using (var scope = host.Services.CreateScope())
                {
                    ...
                    var dataInitializer = new DataAccess.Contract.ComContractDatabaseInitializer();

                    Console.WriteLine("--begin to Initialize the tenant.");
                    dataInitializer.Initialize(tenants);
                    Console.WriteLine("--end to Initialize the tenant.");
